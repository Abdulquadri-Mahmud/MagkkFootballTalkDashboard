...
export default function UpdateNews() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const url = `https://fake-api-one-rust.vercel.app/api/news/update_news/${id}`;
      ...
      <div className="flex-1 h-[100vh] overflow-y-scroll overflow-x-hidden">
        ...
        <form onSubmit={handleSubmit} className='mt-4'>
          <div className="flex justify-between items-center">
            <h1 className='text-xl font-medium'>Update News</h1>
            <div className="">
              ...
              <div className="w-full flex flex-wrap justify-around gap-5">
                ...
                <div className="flex-1 bg-white px-2 py-3 rounded-md">
                  <div className="">
                    ...
                    <input type="text" value={formData.title} onChange={handleChange} id='title' placeholder='Username' className="placeholder:text-sm placeholder:text-gray-300 border border-gray-300 outline-none w-full sm:py-2 py-3 pl-3 rounded-md"/>
                  </div>
                  <div className="my-5">
                    <p className="font-medium pb-2 text-blue-950">Date:</p>
                    <input type="date" value={formData.date} onChange={handleChange} id='date' placeholder='Example@gmail.com' className="placeholder:text-sm placeholder:text-gray-300 border border-gray-300 outline-none w-full sm:py-2 py-3 pl-3 rounded-md"/>
                  </div>
                  <div className="">
                    <p className="font-medium pb-2 text-blue-950">Description:</p>
                    <textarea type="text" value={formData.description} onChange={handleChange} id='description' placeholder='Description' className="placeholder:text-sm placeholder:text-gray-300 h-[150px] border border-gray-300 outline-none w-full sm:py-2 py-3 pl-3 rounded-md"/>
                  </div>
                </div>
